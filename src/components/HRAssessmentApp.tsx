      ...
      <div className="min-h-screen w-full flex flex-col items-center p-4">
        ...
        <main className="w-full max-w-6xl mx-auto">
          ...
          {currentScreen === 'landing' && (
            <div className="fade-in">
              <div className="text-center apple-card p-8 md:p-16">
              ...
              <div className="py-16 md:py-24 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="apple-card p-8 text-left flex flex-col">
          ...
          {/* Login Screen */}
          {currentScreen === 'login' && (
            <div className="fade-in text-center apple-card p-8 md:p-12">
          ...
          {currentScreen === 'role-selection' && (
            <div className="fade-in apple-card p-8 md:p-12">
